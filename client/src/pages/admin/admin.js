...
const FileUpload = lazy(() => import('../hooks/ryslice'))
const HooksTest = lazy(() => import('../hooks/hooks'))
const HooksMySlice = lazy(() => import('../hooks/myslice'))
const HooksMyOrder = lazy(() => import('../hooks/myorder'))
          ...
          <Layout>
            ...
            <Content style={{margin:'100px 14px 14px',background:'#fff'}}>
              ...
              <Suspense fallback={<Loading/>}>
                ...
                <AuthRouter path='/houselist' component={Houselist}/>
                ...
                <AuthRouter path='/hooks/myorder' component={HooksMyOrder}/>
